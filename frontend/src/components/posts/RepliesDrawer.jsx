...
function RepliesDrawer({
	...
	return (
		<div className={`replies-drawer${expanded ? " expanded" : ""}`}>
			<div className="replies-drawer__background">
				<div className="replies-drawer-inner">
					...
					>
						<div className="replies-drawer-scroll" ref={contentRef}>
							{loading ? (
								...
								<>
									...
									{/* Spacer for scrollable content, only when needed */}
									{expanded && contentHeight > DRAWER_MAX_EXPANDED_HEIGHT && (
						...
						<div
							className={`post-comment-input-row${
								expanded && contentHeight > DRAWER_MAX_EXPANDED_HEIGHT
